...
export default function ContactPicker({ value, onChange, disabled }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute z-50 mt-1.5 w-full bg-white rounded-xl border border-gray-200 shadow-md max-h-60 overflow-auto dark:bg-gray-900 dark:border-gray-700">
          <div className="sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-3 py-2">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-full text-sm outline-none text-gray-900 placeholder:text-gray-400 dark:text-gray-100 dark:bg-gray-900 dark:placeholder:text-gray-500"
              />
            </div>
          </div>
          {value && (
            <div
              className="px-3.5 py-2.5 text-sm text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer border-b border-gray-100 dark:border-gray-800"
              onClick={() => {
                onChange("");
                setOpen(false);
                setQuery("");
